          ...
          >
            ...
            <div className="flex flex-wrap gap-2 w-full md:w-auto">
              {!task.status && (
                <button
                  onClick={() => toggleTaskStatus(task.id)}
                  className="flex px-3 py-1 rounded-lg text-sm bg-green-100 text-green-700 hover:bg-green-200 text-center"
                >
                  Mark Complete
                </button>
              )}
              ...
              {editId === task.id ? (
                <button
                  ...
                  className="flex items-center gap-1 flex-1 md:flex-none bg-blue-100 text-blue-700 px-3 py-1 rounded-lg hover:bg-blue-200 transition text-sm justify-center"
                >
                  Save
                </button>
              ) : (
              ...
              <button
                ...
                className="flex items-center gap-1 flex-1 md:flex-none bg-red-100 text-red-700 px-3 py-1 rounded-lg hover:bg-red-200 transition text-sm justify-center"
              >
                <MdDeleteOutline />
                <span>Remove</span>
              </button>
